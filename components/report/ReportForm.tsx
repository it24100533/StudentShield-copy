      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        >
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="text-xs text-zinc-400">
              Urgent Help Needed (Ongoing ragging or physical threat)
            </span>
          </div>
        </button>
        ...
        >
          <div className="flex flex-col items-center space-y-2">
            ...
            <span className="text-xs text-zinc-400">General Complaint (Past incident or warning)</span>
          </div>
        </button>
      </div>
          ...
          {image ? (
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-zinc-400">
                Upload photos, screenshots, or any proof (optional)
              </p>
            </div>
          )}
        </label>
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full rounded-xl bg-zinc-900/50 border border-zinc-800 px-4 py-3.5
                   ...
                   focus:outline-none focus:ring-2 focus:ring-sky-500/40"
          required
          placeholder="Describe what happened. Include details like date/time if possible."
        />
      </div>
